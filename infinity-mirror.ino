...
void testing()
{
    int8_t activeLED = floor(analogRead(POT1_PIN) / floor(1024 / (NUM_LEDS - 1)));
    int8_t hue = floor(analogRead(POT2_PIN) / (1024 / 255));
...
void rainbow() 
{
  int8_t hue = floor(analogRead(POT1_PIN) / (1024 / 255));
